...
#
# bp = Blueprint("account2", __name__)
#
#
# @bp.route("/")
# def index():
...
#         ).fetchone()
#         accountdet2.append(account2)
#     return render_template("blog/index.html", account2=accountdet2)
#
#
...
#             )
#             db.commit()
#             return redirect(url_for("account2.index"))
#
#     return render_template("blog/update2.html", account=account2)
#
